...
/* harmony import */ var _modalscreens__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modalscreens */ "./src/js/modalscreens.js");
...
var GrindTrickRandomizer = /*#__PURE__*/function () {
  function GrindTrickRandomizer() {
    ...
    this.tooltips = new _tooltips__WEBPACK_IMPORTED_MODULE_9__.Tooltips(this.$helpBtn, this);
    this.modalScreen = new _modalscreens__WEBPACK_IMPORTED_MODULE_10__.ModalScreen();
...
var CONFIG = (_CONFIG = {
  ...
  type: 'slot-menu',
  text: 'Abort the game. '
}), _defineProperty(_CONFIG, "approachSlot", {
  type: 'slot',
  text: ' <b>Fakie</b> Skate backwards to the obstacle <b>Switch</b> Grinding in the unnatural mirrored position of a grind.<br>',
  props: {
    placement: 'top-end',
    offset: 2
  },
  slotName: 'Approach'
}), _defineProperty(_CONFIG, "spinToSlot", {
  type: 'slot',
  text: '<b>Inspin</b> If the obstacle is on the left and approach is forwards, Inspin is counter-clockwise. If the obstacle is on the right, Inspin is clockwise.',
  props: {
    placement: 'bottom-end',
    offset: 2
  },
  slotName: 'SpinTo'
}), _defineProperty(_CONFIG, "grindSlot", {
  type: 'slot',
  text: '<b>Frontside Unity</b>grindSlot <br> <img width="250" heigth="250" src="./img/bog/1.jpg">  <br>Open book of grinds  ',
  props: {
    placement: 'top-start',
    offset: 2
  },
  slotName: 'Grind'
}), _defineProperty(_CONFIG, "grindVariationSlot", {
  type: 'slot',
  text: '<b>Topside</b> INside X <img width=100 heigth=100 src="./img/bog/1.jpg">  ',
  props: {
    placement: 'bottom-end',
    offset: 2
  },
  slotName: 'GrindVariation'
}), _defineProperty(_CONFIG, "spinOffSlot", {
  type: 'slot',
  ...
  _createClass(Tooltips, [{
    ...
    value: function init() {
      ...
      this.$tooltips.each(function (i, el) {
        ...
        props.onHide = function (instance) {// ...
        ...
        props.onShow = function (instance) {
          // ...
          console.log("tippy onShow", instance); // instance.disable();
          // this.hide();
          //  tippy.hideAll(instance)
        };
