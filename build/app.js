...
var AboutScreen = function AboutScreen() {
...
/* harmony import */ var _tricktionary_screen__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./tricktionary-screen */ "./src/js/tricktionary-screen.js");
/* harmony import */ var _about_screen__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./about-screen */ "./src/js/about-screen.js");
/* harmony import */ var _trickdata__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./trickdata */ "./src/js/trickdata.js");
/* harmony import */ var _tricklist__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./tricklist */ "./src/js/tricklist.js");
/* harmony import */ var _tooltips__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./tooltips */ "./src/js/tooltips.js");
/* harmony import */ var _modalscreens__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modalscreens */ "./src/js/modalscreens.js");
/* harmony import */ var _audioplayer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./audioplayer */ "./src/js/audioplayer.js");
...
var GrindTrickRandomizer = /*#__PURE__*/function () {
  function GrindTrickRandomizer() {
    ...
    this.audioplayer = new _audioplayer__WEBPACK_IMPORTED_MODULE_13__.Audioplayer(this.$soundOnOff);
    ...
    this.tricktionarySceen = new _tricktionary_screen__WEBPACK_IMPORTED_MODULE_7__.TricktionarySceen();
    this.aboutScreen = new _about_screen__WEBPACK_IMPORTED_MODULE_8__.AboutScreen();
    this.tricklist = new _tricklist__WEBPACK_IMPORTED_MODULE_10__.Tricklist(this.$tricklistBtn);
    this.tooltips = new _tooltips__WEBPACK_IMPORTED_MODULE_11__.Tooltips(this.$helpBtn, this);
    this.modalScreen = new _modalscreens__WEBPACK_IMPORTED_MODULE_12__.ModalScreen();
    this.trickdata = new _trickdata__WEBPACK_IMPORTED_MODULE_9__.Trickdata();
...
var Tricklist = /*#__PURE__*/function () {
  ...
  _createClass(Tricklist, [{
    ...
    value: function render() {
      ...
      var rows = [];
      var html = (0,_helperfunctions_js__WEBPACK_IMPORTED_MODULE_0__.renderTable)("Trick List", ["Points", "Name", "Description"], rows);
      var i = 0;
      this.results.reverse().forEach(function (trick, index) {
        i = i + 1;
        rows.push(_this2.renderRow(trick, _this2.results.length - 1 - index));
      });
      this.$list.html("");
      this.$list.html(html);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TricktionarySceen": () => /* binding */ TricktionarySceen
/* harmony export */ });
...
var CONFIG = null;
var TricktionarySceen = /*#__PURE__*/function () {
  function TricktionarySceen() {
    _classCallCheck(this, TricktionarySceen);
  ...
  _createClass(TricktionarySceen, [{
    key: "renderTOC",
    ...
    value: function renderGrinds() {
      ...
      vars.forEach(function (v) {
        ...
        rows.push([v.name, (0,_helperfunctions_js__WEBPACK_IMPORTED_MODULE_1__.renderThumb)(thumb, url), comment]);
      });
